...
[![Build Status](https://travis-ci.org/HouzuoGuo/tiedot.svg?branch=master)](https://travis-ci.org/HouzuoGuo/tiedot) [![GoDoc](https://godoc.org/github.com/stoplightio/tiedot?status.svg)](https://godoc.org/github.com/stoplightio/tiedot) [Open Build Service](https://build.opensuse.org/package/show/home:guohouzuo/tiedot)
...
[Tutorial: tiedot in 10 minutes]: https://github.com/stoplightio/tiedot/wiki/Tutorial
[API reference and embedded usage]: https://github.com/stoplightio/tiedot/wiki/API-reference-and-embedded-usage
[Version History]: https://github.com/stoplightio/tiedot/wiki/Version-History
[Data structures]: https://github.com/stoplightio/tiedot/wiki/Data-structures
[Query processor and index]: https://github.com/stoplightio/tiedot/wiki/Query-processor-and-index
[Concurrency and networking]: https://github.com/stoplightio/tiedot/wiki/Concurrency-and-networking
[Performance tuning and benchmarks]: https://github.com/stoplightio/tiedot/wiki/Performance-tuning-and-benchmarks
[Limitations]: https://github.com/stoplightio/tiedot/wiki/Limitations
[Email me]: mailto:guohouzuo@gmail.com
[Twitter]: https://twitter.com/hzguo
[blog]: http://allstarnix.blogspot.com.au
[Issues]: https://github.com/stoplightio/tiedot/issues
[Contributors and License]: https://github.com/stoplightio/tiedot/wiki/Contributors-and-License
